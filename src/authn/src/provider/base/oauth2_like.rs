...
use crate::provider::transport::{IdentityLookupRequest, ProviderTransport, TokenExchangeRequest};
use crate::provider::{IProviderAdapter, OAuthLikeCallback, ProviderError};
...
impl<T> OAuthLikeProvider<T> {
    ...
    pub(in crate::provider) fn authorization_url_with_client_id_parameter(
        &self,
        client_id: &str,
        redirect_uri: &str,
        state: &str,
    ...
    pub(in crate::provider) fn authorization_url_with_parameters(
        &self,
        client_id: &str,
        redirect_uri: &str,
        state: &str,
    ...
    pub(in crate::provider) async fn authenticate_with_client_credentials(
        &self,
        callback: OAuthLikeCallback,
        client_id_parameter: &str,
        client_secret_parameter: &str,
    ...
    pub(in crate::provider) async fn authenticate_with_parameters(
        &self,
        callback: OAuthLikeCallback,
        client_id_parameter: &str,
        client_secret_parameter: &str,
